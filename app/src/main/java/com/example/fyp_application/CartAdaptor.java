...
public class CartAdaptor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (cartItemModelList.get(position).getType()) {
            case CartItemModel.CART_ITEM:
                ...
                ((CartItemViewHolder)holder).setItemDetails(productID, resource, title, price, position, inStock);
                break;
            case CartItemModel.TOTAL_AMOUNT:
                int totalItems = 0;
    ...
    class CartItemViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setItemDetails(String productID, String resource, String title, String productPriceText, final int position, boolean inStock) {
